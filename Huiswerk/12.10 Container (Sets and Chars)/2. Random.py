    ...
    if dobbel1_1 == dobbel1_2:
        if dobbel2_1 == dobbel2_2:
            if dobbel3_1 == dobbel3_2:
                print('%d + %d = %d (dubbel)' % (dobbel1_1, dobbel1_2, (dobbel1_1 + dobbel1_2)))
                print('%d + %d = %d (dubbel)' % (dobbel2_1, dobbel2_2, (dobbel2_1 + dobbel2_2)))
                print('%d + %d = (direct naar gevangenis)\n' % (dobbel3_1, dobbel3_2))
            else:
                print('%d + %d = %d (dubbel)' % (dobbel1_1, dobbel1_2, (dobbel1_1 + dobbel1_2)))
                print('%d + %d = %d (dubbel)' % (dobbel2_1, dobbel2_2, (dobbel2_1 + dobbel2_2)))
                print('%d + %d = %d\n' % (dobbel3_1, dobbel3_2, (dobbel3_1 + dobbel3_2)))
        else:
            print('%d + %d = %d (dubbel)' % (dobbel1_1, dobbel1_2, (dobbel1_1 + dobbel1_2)))
            print('%d + %d = %d\n' % (dobbel2_1, dobbel2_2, (dobbel2_1 + dobbel2_2)))
    else:
        print('%d + %d = %d\n' % (dobbel1_1, dobbel1_2, (dobbel1_1 + dobbel1_2)))
